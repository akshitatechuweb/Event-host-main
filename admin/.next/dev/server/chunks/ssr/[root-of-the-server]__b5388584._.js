...
"[project]/hooks/useOtpAuth.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useOtpAuth() {
    ...
    const sendOtp = async (phone)=>{
        try {
            setLoading(true);
            setError(null);
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["requestOtp"])(phone);
            return true;
        } catch (err) {
    ...
    const confirmOtp = async (phone, otp)=>{
        try {
            setLoading(true);
            setError(null);
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["verifyOtp"])(phone, otp);
            return true;
        } catch (err) {
            setError(err.message);
            return false;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useOtpAuth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/hooks/useOtpAuth.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function LoginPage() {
    ...
    const { sendOtp, confirmOtp, loading, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useOtpAuth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useOtpAuth"])();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b5388584._.js.map