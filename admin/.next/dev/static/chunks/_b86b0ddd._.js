...
"[project]/hooks/useOtpAuth.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useOtpAuth() {
    ...
    const sendOtp = async (phone)=>{
        try {
            setLoading(true);
            setError(null);
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["requestOtp"])(phone);
            return true;
        } catch (err) {
    ...
    const confirmOtp = async (phone, otp)=>{
        try {
            setLoading(true);
            setError(null);
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["verifyOtp"])(phone, otp);
            return true;
        } catch (err) {
            setError(err.message);
            return false;
...
_s(useOtpAuth, "Iz3ozxQ+abMaAIcGIvU8cKUcBeo=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useOtpAuth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/hooks/useOtpAuth.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function LoginPage() {
    ...
    const { sendOtp, confirmOtp, loading, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useOtpAuth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useOtpAuth"])();
...
_s(LoginPage, "he6H/GYF5ZFyr27IcXyWVrf8wNQ=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useOtpAuth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useOtpAuth"]
    ];
});
_c = LoginPage;
var _c;
...
//# sourceMappingURL=_b86b0ddd._.js.map