...
function EventsContent() {
  ...
  const [transactionsEventId, setTransactionsEventId] = useState<string | null>(
    null
  );
  const [transactionsEventName, setTransactionsEventName] = useState<
    string | undefined
  >();
  ...
  return (
    <div className="max-w-[1500px] mx-auto px-8 py-10 space-y-10">
      <header className="flex items-center justify-between">
        <div>
          <h1 className="text-4xl font-extrabold tracking-tight bg-linear-to-r from-sidebar-primary to-pink-500 bg-clip-text text-transparent inline-block">
            Events
          </h1>
