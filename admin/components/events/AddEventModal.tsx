...
export interface EventFormData {
  ...
  eventImage: File | null;               // NEW image
  existingEventImage: string | null;     // EXISTING image (important)
  ...
  useEffect(() => {
    if (editingEvent) {
      ...
      setFormData({
        ...
        eventImage: null, // new upload only
        existingEventImage: editingEvent.eventImage || null, // IMPORTANT
