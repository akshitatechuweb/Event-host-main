        ...
        <div className="relative flex flex-col gap-5">
          ...
          <div className="space-y-2">
            <div className="flex items-baseline justify-between gap-3">
              <button
                onClick={() => transaction.userId && setIsModalOpen(true)}
                className={`text-sm text-muted-foreground truncate hover:text-sidebar-primary transition-colors ${
                  transaction.userId ? "cursor-pointer" : "cursor-default"
                }`}
              >
                {transaction.user}
              </button>
